...
public class BookingController {
    ...
    public ResponseEntity<Object> approveBooking(@PathVariable @Positive Long bookingId, @RequestParam @NotNull String approved, @RequestHeader(path) @Positive long userId) {
